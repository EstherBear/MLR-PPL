...
def get_data_loader(args):
    ...
    if args.dataset == 'COCO2014':  
        ...
        train_set = COCO2014('train',
                             ...
                             label_proportion=args.prob, positive_num=args.posNum, 
                             noise_proportion=args.noise, noise_mode=args.noiseMode)
    ...
    return train_loader, test_loader, train_set.changedLabels, train_set.labels
